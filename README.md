...
enableContextMenu| bool		| false		| Enables de default contextual menu behavior of the browser.
onContextMenu| func		| undefined		| Custom event handler for the onContextMenu event.
